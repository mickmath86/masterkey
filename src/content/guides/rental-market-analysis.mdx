...
| Property Address | Bed/Bath | Sq Ft | Rent | $/Sq Ft | Amenities | Days on Market |
|------------------|----------|--------|------|---------|-----------|----------------|
...
**Formula:** Number of units rented ÷ Total available units × 100

- **High absorption (>85%):** Strong demand, consider rent increases
- **Moderate absorption (70-85%):** Balanced market
- **Low absorption (<70%):** Oversupply, competitive pricing needed

### Price Per Square Foot Analysis

This metric helps normalize comparisons:
- Calculate: Monthly rent ÷ Square footage
