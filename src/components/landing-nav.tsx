      ...
      <nav aria-label="Global" className="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-0">
        ...
        <div className="w-screen max-w-6xl flex-auto overflow-hidden rounded-3xl bg-white text-sm/6 shadow-lg outline-1 outline-gray-900/5 dark:bg-gray-800 dark:shadow-none dark:-outline-offset-1 dark:outline-white/10">
          <div className="grid grid-cols-4 gap-x-4 p-6 lg:grid-cols-5 xl:gap-x-6">
                  ...
                  {/* Featured Section */}
                  <a href="/homevalue" className="relative overflow-hidden rounded-2xl group bg-gradient-to-br from-sky-400 via-sky-500 to-blue-600 p-6 text-white animate-in slide-in-from-right-2 duration-300 hover:bg-blue-900 hover:text-white">
                    <div className="relative z-10">
                      <div className="mb-4">
                        <span className="inline-flex items-center rounded-full bg-white/20 px-2 py-1 text-xs font-medium text-white">
                          New Feature
            ...
            <div className="-my-6 divide-y divide-gray-500/10 dark:divide-white/10">
              <div className="space-y-2 py-6">
                ...
                <Disclosure as="div" className="-mx-3">
                  ...
                  <DisclosurePanel className="mt-2 space-y-2">
                    {[...propertyManagementLinks[0].services, ...propertyManagementCallsToAction].map((item) => (
                      <DisclosureButton
                        key={item.name}
                        as="a"
                        href={item.href}
              ...
              <div className="py-6">
                <a
                  href="https://account.rentvine.com/auth/login?access_type=account&redirect_uri=%2Fauth%2Fselect"
