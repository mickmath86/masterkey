...
const TESTIMONIALS = [
    ...
    },
    {
        ...
        testimonial: "Working with Mark, Mike, and Keith at Mathias Real Estate Group has been a great experience so far. Navigating a sale in Malibu can feel overwhelming, but their team has made everything clear and easy to understand. They came in with a thoughtful strategy, strong local knowledge, and communication that actually makes you feel supported. They know what they're doing and genuinely care about getting the best outcome. The process has been smooth up to this point and would absolutely recommend Mathias Real Estate Group to anyone considering selling in Malibu or Ventura County.",
    },
    {
        ...
        <section
            ...
            <div className="mx-auto max-w-5xl px-6">
                <div className="mx-auto max-w-2xl text-balance text-center">
                    ...
                    <p className="text-muted-foreground mb-6 md:mb-12 lg:mb-16">Join hundreds of satisfied property owners who trust Mathias Real Estate Group for expert real estate guidance and property management.</p>
                </div>
                    ...
                    <div className="lg:*:nth-4:rounded-r-none lg:*:nth-5:rounded-br-none lg:*:nth-6:rounded-b-none lg:*:nth-5:rounded-tl-none lg:*:nth-3:rounded-l-none lg:*:nth-2:rounded-tl-none lg:*:nth-2:rounded-br-none lg:*:nth-1:rounded-t-none grid gap-4 sm:grid-cols-2 sm:grid-rows-4 lg:grid-cols-3 lg:grid-rows-3 lg:gap-px">
                        ...
                        <div className="max-lg:rounded-(--radius) lg:rounded-tl-(--radius) lg:rounded-br-(--radius) bg-card ring-foreground/5 row-start-1 flex flex-col justify-between gap-6 border border-transparent p-8 shadow-lg shadow-black/10 ring-1 lg:col-start-1">
                            <div className="space-y-6">
                                <p>"Mathias Real Estate Group is an amazing company. Their talent extends well past property management into construction and Real Estate Brokerage as well. They gave me all the consulting I needed to help me get the highest return I could ask for on my property. Highly recommend!!"</p>
                            </div>
