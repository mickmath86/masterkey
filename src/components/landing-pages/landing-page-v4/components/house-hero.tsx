...
import { HouseHeroIllustration } from "./house-hero-illustration"
                    ...
                    <div className="grid items-center gap-12 md:grid-cols-2">
                        <div className="max-md:text-center">
                            {/* <span className="text-primary text-sm font-medium">Billing</span> */}
                             <div    className="text-primary text-sm font-medium font-mono">3332 Mountain Trail Ave</div   >
                            <h1 className="mt-4 text-balance text-4xl font-semibold md:text-3xl ">Property Profile for: <br /><span className="text-sky-500 uppercase">3332 Mountain Trail Ave</span></h1>
