...
export function CodeBlock({ code, lang, initial, maxHeight, preHighlighted, theme, className }: Props) {
    ...
    return (
        <div
            ...
            {content ? content : <pre className="flex size-full items-center justify-center p-4 text-sm">Loading...</pre>}
        </div>
    )
}