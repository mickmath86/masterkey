        ...
        <div className="mt-10 grid grid-cols-1 gap-4 sm:mt-16 lg:grid-cols-6 lg:grid-rows-2">
            ...
            <div className="relative flex h-full flex-col justify-between overflow-hidden rounded-[calc(var(--radius-lg)+1px)] max-lg:rounded-t-[calc(2rem+1px)] lg:rounded-tl-[calc(2rem+1px)]">
              ...
              <div className="p-10 pt-4">
                ...
                <p className="mt-2 max-w-lg text-sm/6 text-gray-600 dark:text-gray-400">
                 Most agents price homes based on opinions and hope the market agrees. We establish a target price point upfront using real data and professional market analysis, so pricing decisions are grounded in reality from day one.
                </p>
              </div>
            </div>
          ...
          <div className="relative lg:col-span-3">
            ...
            <div className="relative flex h-full flex-col overflow-hidden rounded-[calc(var(--radius-lg)+1px)] lg:rounded-tr-[calc(2rem+1px)]">
              ...
              <div className="p-10 pt-4">
                ...
                <p className="mt-2 text-lg font-medium tracking-tight text-gray-950 dark:text-white">Data-backed target pricing</p>
                <p className="mt-2 max-w-lg text-sm/6 text-gray-600 dark:text-gray-400">
                 Your target price point is based on comprehensive market analysis and professional evaluation — not an agent's estimate. That target number becomes the benchmark we aim for, creating clarity and accountability.
                </p>
              </div>
            </div>
          ...
          <div className="relative lg:col-span-2">
            ...
            <div className="relative flex h-full flex-col justify-between overflow-hidden rounded-[calc(var(--radius-lg)+1px)] lg:rounded-bl-[calc(2rem+1px)]">
              ...
              <div className="p-10 pt-4">
                ...
                <p className="mt-2 max-w-lg text-sm/6 text-gray-600 dark:text-gray-400">
                  Homes that launch with clarity and confidence attract serious buyers early. By establishing a target price point before going live, we create urgency without overpricing — often eliminating the need for future price reductions.
                </p>
              </div>
            </div>
          ...
          <div className="relative lg:col-span-2">
            ...
            <div className="relative flex h-full flex-col justify-between overflow-hidden rounded-[calc(var(--radius-lg)+1px)]">
              ...
              <div className="p-10 pt-4">
                <h3 className="text-sm/4 font-semibold text-sky-600 dark:text-sky-400">Performance Focused</h3>
                <p className="mt-2 text-lg font-medium tracking-tight text-gray-950 dark:text-white">
                 Our success is tied to yours
                </p>
                <p className="mt-2 max-w-lg text-sm/6 text-gray-600 dark:text-gray-400">
                 We're committed to securing offers that align with your target price point. Our pricing strategy, marketing approach, and negotiation tactics are all designed to maximize your return — not just get your home listed.
                </p>
              </div>
            </div>
          ...
          <div className="relative lg:col-span-2">
            ...
            <div className="relative flex h-full flex-col overflow-hidden rounded-[calc(var(--radius-lg)+1px)] max-lg:rounded-b-[calc(2rem+1px)] lg:rounded-br-[calc(2rem+1px)]">
              ...
              <div className="p-10 pt-4">
                ...
                <p className="mt-2 max-w-lg text-sm/6 text-gray-600 dark:text-gray-400">
                 Every listing follows a defined launch process — market analysis, inspection, pricing strategy, and a coordinated market debut — so nothing is rushed, missed, or left to chance.
                </p>
              </div>
            </div>
