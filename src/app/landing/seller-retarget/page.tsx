...
function CTAButtons({
  ...
  return (
    <div className="flex flex-col sm:flex-row gap-3">
      <button
        onClick={handleCall}
        className={`${base} bg-sky-500 hover:bg-sky-400 text-white`}
      >
      ...
      <button
        onClick={onSchedule}
        className={`${base} bg-white border border-gray-200 text-gray-800 hover:border-sky-400 hover:text-sky-600`}
      >
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative overflow-hidden bg-white border-b border-gray-100">
        ...
        <div className="absolute inset-0 pointer-events-none">
          <div className="absolute -top-24 -right-24 w-[500px] h-[500px] rounded-full bg-sky-400/8 blur-3xl" />
          <div className="absolute bottom-0 left-0 w-[400px] h-[400px] rounded-full bg-sky-300/6 blur-3xl" />
        </div>
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-6 lg:px-12 py-16 lg:py-24">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            {/* Left — copy + CTAs */}
            <div>
              <div className="inline-flex items-center gap-2 text-xs font-semibold text-sky-600 bg-sky-50 border border-sky-200 px-3 py-1.5 rounded-full mb-6">
              ...
              <h1 className="text-4xl sm:text-5xl font-bold text-gray-950 leading-tight mb-5">
                Ready to sell?<br />
                <span className="text-sky-500">Let&apos;s talk strategy.</span>
              </h1>
              ...
              <div className="mt-8 flex flex-wrap gap-5">
                {[
                  ...
                  >
                    <CheckCircleIcon className="w-3.5 h-3.5 text-sky-400" />
                    {t}
                  </span>
                ))}
              </div>
              ...
              <div className="relative bg-gray-50 border border-gray-100 rounded-2xl p-8 max-w-sm w-full shadow-sm">
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div className="text-center">
                    <div className="w-24 h-24 mx-auto mb-3 rounded-2xl overflow-hidden border-2 border-sky-100 shadow-sm">
                      <Image
                        src="/mike-avatar.png"
                        alt="Michael Mathias"
                        width={96}
                ...
                <div className="mt-6 pt-5 border-t border-gray-100 space-y-2">
                  <div className="flex items-center gap-2 text-xs text-gray-500">
                    <CheckCircleIcon className="w-3.5 h-3.5 text-sky-400 flex-shrink-0" />
      ...
      <section className="py-20 lg:py-28 bg-white">
        <div className="max-w-6xl mx-auto px-6 lg:px-12">
          <div className="text-center mb-14">
            <span className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-sky-50 border border-sky-100 text-xs font-medium text-sky-600 mb-5">
              Meet your brokers
            </span>
                ...
                {reasons.map((r) => (
                  ...
                  >
                    <div className="w-8 h-8 rounded-lg bg-sky-100 flex items-center justify-center flex-shrink-0 mt-0.5">
                      <r.icon className="w-4 h-4 text-sky-600" />
                    </div>
                    <div>
              ...
              {[
                ...
                >
                  ...
                  <div className="p-4">
                    ...
                    <p className="text-xs text-sky-500 font-medium mt-0.5">{p.title}</p>
              ...
              >
                ...
                <div className="flex gap-0.5 mb-3">
                  {Array.from({ length: t.stars }).map((_, i) => (
                    <StarIcon key={i} className="w-4 h-4 text-sky-400" />
                  ))}
                </div>

                {/* Result badge */}
                <div className="inline-flex self-start items-center gap-1.5 px-2.5 py-1 rounded-full bg-sky-50 border border-sky-100 text-[11px] font-semibold text-sky-600 mb-4">
      ...
      <section className="relative py-20 lg:py-28 bg-white overflow-hidden">
        <div className="absolute inset-0 pointer-events-none">
          <div className="absolute top-0 right-0 w-[500px] h-[500px] rounded-full bg-sky-400/8 blur-3xl" />
          <div className="absolute bottom-0 left-0 w-[400px] h-[400px] rounded-full bg-sky-300/6 blur-3xl" />
        </div>

        <div className="relative z-10 max-w-3xl mx-auto px-6 lg:px-12 text-center">
          <div className="inline-flex items-center gap-2 text-xs font-semibold text-sky-600 bg-sky-50 border border-sky-100 px-3 py-1.5 rounded-full mb-6">
          ...
          <h2 className="text-3xl sm:text-4xl font-bold text-gray-950 leading-tight mb-4">
            ...
            <span className="text-sky-500">the best possible outcome.</span>
          </h2>
