...
function ThreeCard() {
  ...
  return (
    <Container>
          ...
          From first-time sellers to experienced investors, <span className=" text-sky-500">MasterKey</span> provides proven marketing strategies and cutting-edge technology to help you sell your home quickly and for the highest possible price.
          </Lead>
