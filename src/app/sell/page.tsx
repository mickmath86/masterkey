...
import { ArrowRight, Home, Key, DollarSign, Star, Link } from "lucide-react"
      ...
      <div className="mx-auto max-w-7xl px-6 pt-10 pb-24 sm:pb-32 lg:flex lg:px-8 lg:py-40">
        <div className="mx-auto max-w-2xl shrink-0 lg:mx-0 lg:pt-8">
          ...
          <div className="mt-24 sm:mt-32 lg:mt-16">
            <a href="#" className="inline-flex space-x-6">
              ...
              <span className="inline-flex items-center space-x-2 text-sm/6 font-medium text-gray-600 dark:text-gray-300">
                <span>Expert agents focused on maximizing your sale</span>
          ...
          <p className="mt-8 text-lg font-medium text-pretty text-gray-500 sm:text-xl/8 dark:text-gray-400">
            Our selling specialists combine proven marketing strategies with cutting-edge technology to maximize your home's value and minimize time on market. From pricing strategy to closing, we deliver results.
          </p>
...
function ThreeCard() {
  ...
  return (
    <Container>
          <Subheading className="mt-16">Expert Selling Services</Subheading>
          <Heading as="h1" className="mt-2">
            Maximize Your Home's Value
          </Heading>
          <Lead className="mt-6 max-w-3xl">
          From first-time sellers to experienced investors, <span className=" text-sky-500">Mathias Real Estate Group</span> provides proven marketing strategies and cutting-edge technology to help you sell your home quickly and for the highest possible price.
          </Lead>
...
const sellingSteps = [
  {
    name: 'Property Valuation & Strategy',
    description: 'Get an accurate market valuation and develop a customized selling strategy to maximize your return.',
  },
  { 
    name: 'Prepare & Market Your Home', 
    description: 'Professional staging, photography, and multi-channel marketing to attract qualified buyers.' 
  },
  {
    name: 'Review & Negotiate Offers',
    description: 'Expert evaluation of offers and skilled negotiation to secure the best terms and highest price.',
  },
  { 
    name: 'Close & Transfer Ownership', 
    description: 'Handle all closing details, inspections, and paperwork to ensure a smooth transaction.' 
  },
]
function HowItWorks() {
  return (
        ...
        <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 sm:gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-5">
          <div className="col-span-2">
            ...
            <p className="mt-2 text-4xl font-semibold tracking-tight text-pretty text-gray-900 sm:text-5xl dark:text-white">
              Your Path to Maximum Value
            </p>
            <p className="mt-6 text-base/7 text-gray-700 dark:text-gray-300">
              Our proven 4-step process maximizes your home's sale price while minimizing stress. From valuation to closing, we handle every detail.
            </p>
            <div className="mt-8">
              <a
                href="/contact"
  ...
  const services = [
    {
      name: 'Listing Strategy & Pricing',
      description: 'Strategic pricing analysis and market positioning to attract buyers while maximizing your return.',
      icon: CloudArrowUpIcon,
      href: '#',
    },
    {
      name: 'Professional Marketing',
      description: 'High-quality photography, virtual tours, and multi-platform marketing to showcase your home.',
      icon: LockClosedIcon,
      href: '#',
    },
    {
      name: 'Offer Review & Negotiation',
      description: 'Expert evaluation of buyer offers and skilled negotiation to secure the best terms and price.',
      icon: ArrowPathIcon,
      href: '#',
    },
    {
      name: 'Home Preparation Guidance',
      description: 'Professional staging advice and improvement recommendations to maximize buyer appeal.',
      icon: FingerPrintIcon,
      href: '#',
    },
    {
      name: 'Market Analytics & Reporting',
      description: 'Real-time market data and performance analytics to track your listing\'s success.',
      icon: Cog6ToothIcon,
      href: '#',
    },
    {
      name: 'Closing Coordination',
      description: 'Full-service management of inspections, appraisals, and closing process from contract to keys.',
      icon: ServerIcon,
      href: '#',
    },
  ]
      ...
      <div id="services"className="bg-white py-24 sm:py-32 dark:bg-gray-900">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl lg:text-center">
            <h2 className="text-base/7 font-semibold text-sky-600 dark:text-sky-400">Complete Selling Services</h2>
            <p className="mt-2 text-4xl font-semibold tracking-tight text-pretty text-gray-900 sm:text-5xl lg:text-balance dark:text-white">
              Everything you need to sell successfully
            </p>
            <p className="mt-6 text-lg/8 text-gray-600 dark:text-gray-300">
              From initial valuation to final closing, our comprehensive selling services provide expert marketing and cutting-edge technology to maximize your home's value and minimize time on market.
            </p>
          </div>
...
const faqs = [
  {
    ...
    answer:
      "We provide a comprehensive market analysis using recent comparable sales, current market conditions, and your home's unique features. Our AI-powered valuation tool gives you an instant estimate, and our agents provide detailed pricing strategies.", 
  },
  {
    question: 'How long does it take to sell a home?',
    answer:
      'The average time varies by market and price range, but typically 30-60 days from listing to closing. Our strategic pricing and marketing approach often results in faster sales, with many homes selling within the first few weeks.',
  },
  {
    question: 'What costs are involved in selling my home?',
    answer:
      'Typical costs include agent commissions (5-6%), closing costs (1-3%), and potential repairs or improvements. We\'ll provide a detailed net proceeds estimate upfront so you know exactly what to expect.',
  },
  {
    question: 'Should I make repairs before listing?',
    answer:
      "We\'ll conduct a pre-listing assessment to identify which improvements offer the best return on investment. Some repairs are essential, while others may not be worth the cost. We\'ll guide you through the decision-making process.",
  },
  {
    question: "What if I receive multiple offers?",
    answer:
      'Multiple offers are great! We\'ll help you evaluate each offer based on price, terms, financing strength, and closing timeline. Our negotiation expertise ensures you get the best overall deal, not just the highest price.',
  },
  {
    question: 'Do I need to stage my home?',
    answer:
      "Staging can significantly impact buyer perception and sale price. We\'ll assess your home and recommend whether professional staging, minor updates, or simple decluttering will give you the best return on investment.",
  },
  {
    question: 'What happens during the inspection period?',
    answer:
      'After accepting an offer, buyers typically have 7-10 days to inspect the property. We\'ll guide you through any repair requests and help negotiate fair resolutions that keep the sale on track.',
  },
  {
    question: 'Can I sell my home if I still owe money on it?',
    answer:
      'Yes, most sellers have an existing mortgage. At closing, the loan balance is paid off from the sale proceeds. We\'ll coordinate with your lender to ensure a smooth payoff process.',
  },
  {
    question: 'What marketing strategies do you use?',
    answer:
      'We use professional photography, virtual tours, MLS listing, social media marketing, online advertising, and our extensive network. Our multi-channel approach ensures maximum exposure to qualified buyers.',
  },
  {
    question: 'What should I do to prepare my home for showings?',
    answer:
      'Keep your home clean, decluttered, and well-lit. We\'ll provide a detailed preparation checklist and can arrange professional cleaning or staging services. First impressions are crucial for attracting serious buyers.',
  },
]
      ...
      <div className="mx-auto max-w-7xl px-6 py-24 sm:py-32 lg:px-8 lg:py-40">
        <div className="mx-auto max-w-4xl">
          <h2 className="text-4xl font-semibold tracking-tight text-gray-900 sm:text-5xl dark:text-white">
            Frequently asked <span className="text-sky-600">seller</span> questions
          </h2>
